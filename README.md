...
This library provides instant integration (PnP) support for WIFI-Direct P2P into any Android projects plus it remembers the recently connected device and reconnects it automatically when it's available.
